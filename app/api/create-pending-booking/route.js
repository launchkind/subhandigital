  ...
  try {
    ...
    const { data, error } = await supabase
      ...
      .insert([{
        ...
        service_needed: bookingData.serviceNeeded,
        short_description: bookingData.shortDescription,
        approx_budget: bookingData.approxBudget,
        project_start: bookingData.projectStart,
        existing_website: bookingData.existingWebsite,
        given_by: "subhan",
